...
A machine learning project to classify employee engagement (High, Medium, Low) using historical workforce data such as absenteeism, performance, and work-related factors.
...
2. **Random Forest Classifier**  
   ...
   - Hyperparameter tuning performed (e.g., `max_depth`, `n_estimators`, `min_samples_split`)  
